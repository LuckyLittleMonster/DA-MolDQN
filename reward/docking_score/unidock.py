...
# Default unidock binary path (env var > config > 'unidock' on PATH)
_UNIDOCK_BIN_DEFAULT = os.environ.get('UNIDOCK_BIN', 'unidock')
...
class UniDockScorer:
    ...
    def __init__(self, receptor_pdbqt, center_x, center_y, center_z,
                 ...
                 max_embed_attempts=7, unidock_bin=None):
        ...
        self.unidock_bin = unidock_bin or _UNIDOCK_BIN_DEFAULT
    ...
    def _run_unidock(self, sdf_paths, out_dir):
        ...
        try:
            ...
            print(f"[UniDockScorer] unidock binary not found: {self.unidock_bin}")
            return False
