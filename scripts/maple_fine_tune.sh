...
for i in $(seq 0 255); do
    echo $i
	python main_hpc.py --experiment maple_5ft --trial $i --init_mol_start $i --iteration 2000 --init_mol_path  ./Data/anti_400.txt --gpu_list 0 --num_init_mol 1 --max_steps_per_episode 10 --reward bde_ip --eps_decay 0.968 --max_batch_size 128 --cache bde --maintain_OH exist --checkpoint maple_5 --eps_threshold 0.5 &
    if (( (i + 1) % 16 == 0 )); then
