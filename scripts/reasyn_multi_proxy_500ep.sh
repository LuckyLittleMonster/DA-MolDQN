...
#SBATCH --output=Experiments/logs/reasyn_multi_proxy_500ep_%j.out
#SBATCH --error=Experiments/logs/reasyn_multi_proxy_500ep_%j.err
...
echo "======================================"
echo "ReaSyn + Multi-objective (proxy, product)"
