...
# Examples:
#   sbatch train_reasyn.sh seh dock_baseline 1    # T7: RxnFlow-matching
#   sbatch train_reasyn.sh seh multi 1            # T8: MOO product
#   sbatch train_reasyn.sh drd2 dock 1            # T9: RGFN-matching
#   sbatch train_reasyn.sh drd2 multi 1           # T10: MOO product
#   sbatch train_reasyn.sh gsk3b dock 1           # T11: HN-GFN-matching
