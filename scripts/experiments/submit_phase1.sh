...
# Using maple_night QOS: no GPU limit, all 12 jobs can run in parallel.
#
...
echo ""
echo "=== All 12 Phase 1 jobs submitted (parallel, no QOS limit) ==="
echo "Monitor: squeue -u \$USER"
echo "Route:  ${J1},${J2},${J3},${J4},${J5},${J6}"
echo "ReaSyn: ${J7},${J8},${J9},${J10},${J11},${J12}"
