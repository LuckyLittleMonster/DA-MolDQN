...
#SBATCH --output=log/alf2_64r_%j.out
#SBATCH --error=log/alf2_64r_%j.err

###############################################################################
# ALFABET 64-rank DDP v2 — rerun with save bug fix
###############################################################################

set -euo pipefail

echo "============================================"
echo "ALFABET 64-rank DDP v2 (save fix)"
