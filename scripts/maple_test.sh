...
python main_hpc.py --experiment qed_test --note 'qed test' --trial 0 --iteration 80000 --init_mol_path  ./Data/anti_400.txt --gpu_list 0 --num_init_mol 1 --max_steps_per_episode 10 --reward qed --reward_weight 1.0 --max_batch_size 128
