...
from reasyn.chem.featurize import TokenType, decode_smiles
...
from reasyn.utils.sample_utils import (
                ...
                if self._finished:
                    ...
                    if finished:
                        ...
                        for _ in range(self._max_active_states):
                            from reasyn.utils.sample_utils import get_sub_stacks, State
